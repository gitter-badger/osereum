...
from osereum.wsgi import application as wsgi_handler
django.setup()
...
class MyClientProtocol(WebSocketClientProtocol):
    ...
    def onOpen(self):
        ...
        def hello():
            #self.sendMessage(u"Hello, from 188.166.93.125  !".encode('utf8'))
            data = {}
            data["server"] = True
            data["host"] = ip
    ...
    def onClose(self, wasClean, code, reason):
        ...
        def byebye():
            self.sendMessage(u"Good byee, from 188.166.93.125  !".encode('utf8'))

        byebye()


def syncfirst():
    r = requests.get('http://188.166.116.157/api/v1/alltransactions/')
    alltrans = r.json()
...
if __name__ == '__main__':
    ...
    factory = WebSocketClientFactory(u"ws://188.166.116.157:9000")
    factory.protocol = MyClientProtocol

    reactor.connectTCP(u"188.166.116.157", 9000, factory)
